...
public class SimpleWeldClassTest {
    ...
    */
    ...
    public void testWeldClassForGenericSuperclass() {
        EnhancedAnnotatedType<StringProcessor> weldClass = new ClassTransformer(new TypeStore(), new SharedObjectCache(), new ReflectionCache()).getEnhancedAnnotatedType(StringProcessor.class);
