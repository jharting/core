...
public class SimpleWeldClassTest {
    ...
    */
    ...
    public void testWeldClassForCovariantReturnType() {
        EnhancedAnnotatedType<Attacker> weldClass = new ClassTransformer(new TypeStore(), new SharedObjectCache(), new ReflectionCache()).getEnhancedAnnotatedType(Attacker.class);
