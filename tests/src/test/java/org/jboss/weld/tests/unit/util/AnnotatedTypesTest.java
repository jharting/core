...
public class AnnotatedTypesTest {
    ...
    public void testComparison() throws SecurityException, NoSuchFieldException, NoSuchMethodException {
        ...
        EnhancedAnnotatedType<Chair> chair1 = EnhancedAnnotatedTypeImpl.of(BackedAnnotatedType.of(Chair.class, ct, new SharedObjectCache()), ct);
        EnhancedAnnotatedType<Chair> chair2 = EnhancedAnnotatedTypeImpl.of(BackedAnnotatedType.of(Chair.class, ct, new SharedObjectCache()), ct);
