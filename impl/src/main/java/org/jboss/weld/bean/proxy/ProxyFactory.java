...
public class ProxyFactory<T> {
    ...
    protected static final String LBEAN_IDENTIFIER_STRING = "Lorg/jboss/weld/serialization/spi/BeanIdentifier;";
    ...
    private static String createCompoundProxyName(Bean<?> bean, TypeInfo typeInfo, StringBuilder name) {
        ...
        if (bean != null) {
            final BeanIdentifier id = Container.instance().services().get(ContextualStore.class).putIfAbsent(bean);
